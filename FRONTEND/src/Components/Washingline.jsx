    ...
    <div className="washing-line-container">
      ...
      <div className="side-info right">
        ...
        <p>
          ...
          .<br />
          <strong>Cleaning staff:</strong> Handle daily cleaning tasks.
          <br />
          <strong>Maintenance staff:</strong> Carry out minor repairs.
          <br />
          <strong>Depot Manager:</strong> Oversees operations and quality
          checks.
        </p>
      </div>
    </div>
