...
const WashingLineDetails = () => {
  return (
    <div className="details-page">
      ...
      <p>
        <strong>Location:</strong> Primary maintenance depot (where the rake is
        allotted).
      </p>
      <p>
        <strong>Purpose:</strong> Thorough examination and maintenance of the
        train, including undergear inspection, brake system checks, and
        addressing any defects.
      </p>
      <ul>
        <li>Rolling-in examination (including axle box feeling)</li>
        <li>
          Inspection and repair of running gear fittings, brake gear, spring
          gear, and draw and buffing gear
        </li>
        ...
        <li>
          Ensuring proper supply of brake van equipment for originating trains
        </li>
        <li>Sending coaches for POH or NPOH as per requirement</li>
        <li>
          Intensive attention to brake gearing, slack adjuster 'A' dimension,
          and brake cylinder stroke
        </li>
        <li>Replacing missing passenger amenity fittings</li>
        <li>Intensive cleaning of coach toilets</li>
      </ul>
      <p>
        <strong>Documentation:</strong> Brake Power Certificate (BPC)
      </p>

      <h2>Secondary Examination</h2>
      <p>
        <strong>Location:</strong> Terminal stations
      </p>
      <p>
        <strong>Purpose:</strong> Ensures the train is fit for its return trip
      </p>
      <ul>
